import { AbilityName, IAbilities } from "./iabilitities.interface";
 ...
 * 
 * @field translationKey - The key of the string in the translation file
...
interface SpecialAbility {
    ...
    params?: any; // Should actually be { [key: string]: string | number }, but this throws errors if there are SpecialAbility[] with different amounts of params
}
